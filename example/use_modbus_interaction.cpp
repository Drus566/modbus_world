...
int main(void)
{
	...
	// std::unique_ptr<mb::core::IModbusInteraction> core1 = mb::core::IModbusInteraction::create(rtu_con1);
...
void rtuCon2Func() {
	...
	std::unique_ptr<mb::core::IModbusInteraction> core2 = mb::core::IModbusInteraction::create(rtu_con2);
